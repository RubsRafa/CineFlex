...
export default function App() {
  ...
  return (
    ...
    {tela2 && <TelaSessoes setTela2={setTela2} setTela3={setTela3} />}
    {tela3 && <TelaAssentos setTela3={setTela3} setTela4={setTela4} />}
    {tela4 && <TelaSucesso setTela4={setTela4} setTela1={setTela1} />}
    ...
    {!tela1 && !tela4 && <Rodape>
                ...
                <InfoFilme>
                <h1>Enola Holmes</h1>
                {tela3 && <h1>Quinta-feira - 15:00</h1>}
                </InfoFilme>
            </Rodape>}
    </>
  );
